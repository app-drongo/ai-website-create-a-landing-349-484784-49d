...
export default function Cta() {
  ...
  const stats = [
    { value: '25K+', label: 'Invoices Sent', icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of small businesses and freelancers who trust MyApp Invoicing for
                their billing and accounting needs. Start managing your finances like a pro.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Create your first invoice in under 15 minutes
              </p>
            </div>
          </div>
        </div>

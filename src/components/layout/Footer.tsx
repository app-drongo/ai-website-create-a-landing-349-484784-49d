  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Tax Reporting', href: '/tax-reports' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Invoice Guide', href: '/invoice-guide' },
        { name: 'Tax Resources', href: '/tax-resources' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="#home" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl">MyApp Invoicing</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamline your billing process with professional invoicing software. Join thousands
                of businesses who trust MyApp Invoicing for faster payments and better cash flow.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">billing@myappinvoicing.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 MyApp Invoicing. All rights reserved.</span>
              <span className="hidden sm:inline">•</span>
              <span className="hidden sm:inline flex items-center gap-1">
                Made with <Heart className="size-3 text-red-500 fill-current" /> for business owners
              </span>
            </div>
